...
class TestInventoryManager(unittest.TestCase):
    ...
    def test_add_product(self):
        ...
        self.assertIn(self.chaise.name, self.inventory_manager.list_products())
    ...
    def test_remove_product(self):
        ...
        self.assertNotIn(self.pantalon.name, self.inventory_manager.list_products())
    ...
    def test_sell_product(self):
        ...
        self.assertEqual(3, self.inventory_manager.get_product('Pantalon').quantity)
    ...
    def test_restock_product(self):
        ...
        self.assertEqual(15, self.inventory_manager.get_product('Chaise').quantity)
    ...
    def test_get_product(self):
        ...
        """
        self.inventory_manager.add_product(self.chaise, 5)
        chaise = self.inventory_manager.get_product('Chaise')
        self.assertEqual(chaise, self.inventory_manager.get_product('Chaise'))
    ...
    def test_list_products(self):
        ...
        """
        self.inventory_manager.add_product(self.chaise, 5)
        list_products = self.inventory_manager.list_products()
        output = "'Chaise': Chaise (Ikea): 5 in stock, price:100"
        self.assertEqual(output, list_products)
